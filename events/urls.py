...
from events.views import event_detail, event_create,event_list,category_list,category_create,category_delete,category_update,event_delete,event_update,organizer_dashboard
